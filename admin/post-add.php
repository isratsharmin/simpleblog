...
if(isset($_POST['form1'])) {
	...
	try {
		...
		$statement = $db->prepare("INSERT INTO post (post_title,post_description,post_image,cart_id,tag_id,post_date,year,month,post_timestamp) VALUES (?,?,?,?,?,?,?,?,?)");
		$statement->execute(array($_POST['post_title'],$_POST['post_description'],$f1,$_POST['cart_id'],$tag_ids,$post_date,$year,$month,$post_timestamp));
...
{
	?>
	<option value="<?php echo $row['cart_id']; ?>"><?php echo $row['cart_name']; ?></option>
	<?php
}
?>
</select>
